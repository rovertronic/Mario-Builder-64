...
extern s16 newcam_active; // basically the thing that governs if newcam is on.
...
extern s16 opt_music;
extern s16 opt_widescreen;
extern s16 opt_minimap;
extern s16 opt_showhud;
