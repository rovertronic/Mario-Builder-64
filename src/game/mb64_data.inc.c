...
/* OBJECT_TYPE_TRIGGER */       {"Star Trigger",            mat_b_btn_star,         bhvStaticObject,   TILE_SIZE/2, MODEL_MAKER_IMBUE_TRIGGER, OBJ_TYPE_IS_BILLBOARDED | OBJ_TYPE_IMBUABLE, OBJ_OCCUPY_INNER, 0, 0, 1.0f, NULL, NULL, 0},
};
