...
/* OBJECT_TYPE_ON_OFF_BLOCK */  {"On-Off Block",            mat_b_btn_block,        bhvOnOffBlock,     0,           MODEL_MAKER_BLOCK_1,       0,                       0, 0, 1.0f, NULL, df_block, SOUND_GENERAL_DOOR_TURN_KEY},
/* OBJECT_TYPE_WOODPLAT */      {"Wooden Platform",         mat_b_btn_woodplat,     bhvWoodPlat,       0,           MODEL_MAKER_WOODPLAT,      0,                       0, 0, 1.0f, NULL, NULL, SOUND_GENERAL_POUND_WOOD_POST},
...
u8 cmm_toolbox_btcm[TOOLBOX_SIZE] = {
    ...
    CMM_BUTTON_MPLAT, CMM_BUTTON_PURPLE_SWITCH, CMM_BUTTON_TIMED_BOX, CMM_BUTTON_BREAKABLE, CMM_BUTTON_DIAMOND, CMM_BUTTON_WOODPLAT, CMM_BUTTON_NPC, _, _,
