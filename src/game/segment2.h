...
extern Texture texture_transition_bowser[];
extern Texture texture_transition_showrunner[];
extern Texture mb64_painting_frame[];
extern Texture mb64_painting_unknown[];
extern Gfx mb64_line_mat_dl[];
...
extern Texture *main_hud_lut[91];
