...
#include "actors/grindel/6.rgba16.inc.c"
};

// 0x07002800 - 0x07003800
ALIGNED8 static const Texture grindel_texture_2[] = {
#include "actors/grindel/5.rgba16.inc.c"
};

ALIGNED8 const Texture grind_nis_texture[] = {
#include "actors/grindel/bob.rgba16.inc.c"
};
...
const Gfx ssl_seg7_dl_070221E8[] = {
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_AA_ZB_TEX_EDGE, G_RM_TEX_EDGE2),
    gsDPSetDepthSource(G_ZS_PIXEL),
    gsDPSetFogColor(0, 0, 0, 255),
    gsSPFogFactor(0x0E49, 0xF2B7), // This isn't gsSPFogPosition since there is no valid min/max pair that corresponds to 0x0E49F2B7
    gsSPClearGeometryMode(G_FOG),
