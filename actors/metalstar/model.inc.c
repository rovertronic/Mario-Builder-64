...
ALIGNED8 static const u8 metalstar_seg3_texture_body[] = {
#include "actors/metalstar/custom_metalstartex.rgba16.inc.c"
};

ALIGNED8 static const u8 metalstar_seg3_texture_eye[] = {
#include "actors/metalstar/star_eye.rgba16.inc.c"
};

static const Vtx metalstar_seg3_vertex_body[] = {
...
const Gfx metalstar_seg3_sub_dl_body[] = {
    gsSPVertex(metalstar_seg3_vertex_body, 12, 0),
...
const Gfx metalstar_seg3_dl_body[] = {
    ...
    gsDPLoadTextureBlock(metalstar_seg3_texture_body, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 64, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_WRAP | G_TX_NOMIRROR, 5, 6, G_TX_NOLOD, G_TX_NOLOD),
    gsSPTexture(0x07C0, 0x07C0, 0, G_TX_RENDERTILE, G_ON),
    gsSPDisplayList(metalstar_seg3_sub_dl_body),
    gsDPPipeSync(),
...
const Gfx metalstar_seg3_sub_dl_eyes[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, metalstar_seg3_texture_eye),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(metalstar_seg3_vertex_eyes, 10, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
...
const Gfx metalstar_seg3_dl_eyes[] = {
    ...
    gsSPDisplayList(metalstar_seg3_sub_dl_eyes),
