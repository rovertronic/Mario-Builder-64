Lights1 slope_MakerPassthru_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFE, 0xFE, 0xFE, 0x28, 0x28, 0x28);

Vtx slope_slope_mesh_vtx_0[18] = {
...
Gfx slope_slope_mesh_tri_0[] = {
	gsSPVertex(slope_slope_mesh_vtx_0 + 0, 18, 0),
...
Gfx mat_slope_MakerPassthru[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsSPSetLights1(slope_MakerPassthru_lights),
	gsSPEndDisplayList(),
};

Gfx slope_slope_mesh[] = {
	gsSPDisplayList(mat_slope_MakerPassthru),
	gsSPDisplayList(slope_slope_mesh_tri_0),
	gsDPPipeSync(),
