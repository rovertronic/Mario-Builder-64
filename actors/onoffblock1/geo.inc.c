...
const GeoLayout onoffblock1_000_switch_opt2[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, onoffblock1_000_displaylist_mesh_layer_1_mat_override_yellowblock_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout onoffblock1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_BRANCH(1, onoffblock1_000_switch_opt2),
		GEO_CLOSE_NODE(),
