...
#include "actors/checkerboard_platform/checkerboard_platform_side_custom.rgba16.inc.c"
};
...
static const Vtx checkerboard_platform_seg8_vertex_0800D440[] = {
    {{{  -256,     28,    128}, 0, {  1504,    480}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -256,    128,    128}, 0, {  1504,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -256,    128,   -128}, 0, {     0,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -256,     28,   -128}, 0, {     0,    480}, {0x81, 0x00, 0x00, 0xff}}},
    {{{   256,     28,   -128}, 0, {  1504,    480}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   256,    128,    128}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   256,     28,    128}, 0, {     0,    480}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   256,    128,   -128}, 0, {  1504,      0}, {0x7f, 0x00, 0x00, 0xff}}},
};

// 0x0800D4C0
static const Vtx checkerboard_platform_seg8_vertex_0800D4C0[] = {
    {{{   256,     28,    128}, 0, {  2528,    992}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -256,     28,   -128}, 0, {     0,   -512}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   256,     28,   -128}, 0, {  2528,   -512}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   256,    128,   -128}, 0, {  2528,   -512}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -256,    128,    128}, 0, {     0,    992}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   256,    128,    128}, 0, {  2528,    992}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -256,    128,   -128}, 0, {     0,   -512}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -256,     28,   -128}, 0, {  2528,    480}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -256,    128,   -128}, 0, {  2528,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   256,    128,   -128}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   256,     28,   -128}, 0, {     0,    480}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   256,     28,    128}, 0, {  2528,    480}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -256,    128,    128}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -256,     28,    128}, 0, {     0,    480}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   256,    128,    128}, 0, {  2528,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -256,     28,    128}, 0, {     0,    992}, {0x00, 0x81, 0x00, 0xff}}},
};
