...
static const Vtx breakable_box_seg8_vertex[] = {
    {{{  -128,      0,   -128}, 0, {   1024,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -128,      0,    128}, 0, {   1024,    1024}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -128,    256,    128}, 0, {     0,    1024}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -128,      0,    128}, 0, {     0,    1024}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   128,      0,    128}, 0, {   1024,    1024}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   128,    256,    128}, 0, {   1024,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -128,    256,    128}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   128,      0,   -128}, 0, {   1024,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   128,      0,    128}, 0, {     0,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -128,      0,    128}, 0, {     0,    1024}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -128,      0,   -128}, 0, {   1024,    1024}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   128,    256,   -128}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   128,    256,    128}, 0, {     0,    1024}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   128,      0,    128}, 0, {   1024,    1024}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   128,      0,   -128}, 0, {   1024,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{  -128,    256,    128}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   128,    256,   -128}, 0, {   1024,    1024}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -128,    256,   -128}, 0, {   1024,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   128,    256,    128}, 0, {     0,    1024}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   128,    256,   -128}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   128,      0,   -128}, 0, {     0,    1024}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -128,      0,   -128}, 0, {   1024,    1024}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -128,    256,   -128}, 0, {   1024,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -128,      0,   -128}, 0, {   1024,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -128,    256,    128}, 0, {     0,    1024}, {0x81, 0x00, 0x00, 0xff}}},
...
const Gfx breakable_box_seg8_sub_dl_begin[] = {
    ...
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_WRAP, 5, G_TX_NOLOD, G_TX_WRAP, 5, G_TX_NOLOD),
