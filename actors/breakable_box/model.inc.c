...
static const Vtx breakable_box_seg8_vertex[] = {
    {{{  -128,      0,   -128}, 0, {   992,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -128,      0,    128}, 0, {   992,    992}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -128,    256,    128}, 0, {     0,    992}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -128,      0,    128}, 0, {     0,    992}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   128,      0,    128}, 0, {   992,    992}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   128,    256,    128}, 0, {   992,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{  -128,    256,    128}, 0, {     0,      0}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   128,      0,   -128}, 0, {   992,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   128,      0,    128}, 0, {     0,      0}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -128,      0,    128}, 0, {     0,    992}, {0x00, 0x81, 0x00, 0xff}}},
    {{{  -128,      0,   -128}, 0, {   992,    992}, {0x00, 0x81, 0x00, 0xff}}},
    {{{   128,    256,   -128}, 0, {     0,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   128,    256,    128}, 0, {     0,    992}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   128,      0,    128}, 0, {   992,    992}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{   128,      0,   -128}, 0, {   992,      0}, {0x7f, 0x00, 0x00, 0xff}}},
    {{{  -128,    256,    128}, 0, {     0,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   128,    256,   -128}, 0, {   992,    992}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{  -128,    256,   -128}, 0, {   992,      0}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   128,    256,    128}, 0, {     0,    992}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   128,    256,   -128}, 0, {     0,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   128,      0,   -128}, 0, {     0,    992}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -128,      0,   -128}, 0, {   992,    992}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -128,    256,   -128}, 0, {   992,      0}, {0x00, 0x00, 0x81, 0xff}}},
    {{{  -128,      0,   -128}, 0, {   992,      0}, {0x81, 0x00, 0x00, 0xff}}},
    {{{  -128,    256,    128}, 0, {     0,    992}, {0x81, 0x00, 0x00, 0xff}}},
