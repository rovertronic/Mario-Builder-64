Lights1 dslope_MakerPassthru_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFE, 0xFE, 0xFE, 0x28, 0x28, 0x28);

Vtx dslope_dslope_mesh_vtx_0[18] = {
	...
	{{{150, -150, -150},0, {-16, 1008},{0x0, 0xA6, 0x5A, 0xFF}}},
	{{{150, 150, 150},0, {-16, -16},{0x0, 0xA6, 0x5A, 0xFF}}},
	{{{-150, 150, 150},0, {1008, -16},{0x0, 0xA6, 0x5A, 0xFF}}},
	{{{-150, -150, -150},0, {1008, 1008},{0x0, 0xA6, 0x5A, 0xFF}}},
};

Gfx dslope_dslope_mesh_tri_0[] = {
	gsSPVertex(dslope_dslope_mesh_vtx_0 + 0, 18, 0),
...
Gfx mat_dslope_MakerPassthru[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsSPSetLights1(dslope_MakerPassthru_lights),
	gsSPEndDisplayList(),
};

Gfx dslope_dslope_mesh[] = {
	gsSPDisplayList(mat_dslope_MakerPassthru),
	gsSPDisplayList(dslope_dslope_mesh_tri_0),
	gsDPPipeSync(),
