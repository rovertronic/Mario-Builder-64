...
#define RM_TEX_EDGE_DECAL(clk) \
	AA_EN | Z_CMP | IM_RD | CVG_DST_WRAP | ZMODE_DEC | CVG_X_ALPHA | ALPHA_CVG_SEL | \
	GBL_c##clk(G_BL_CLR_IN, G_BL_A_IN, G_BL_CLR_MEM, G_BL_A_MEM)

#define RM_VPLEX_SCREEN(clk) \
	Z_CMP | Z_UPD | IM_RD | CVG_DST_CLAMP | ZMODE_OPA | \
	GBL_c##clk(G_BL_CLR_MEM, G_BL_0, G_BL_CLR_MEM, G_BL_1)
...
#define G_RM_TEX_EDGE_DECAL 	    RM_TEX_EDGE_DECAL(1)
#define G_RM_TEX_EDGE_DECAL2 	    RM_TEX_EDGE_DECAL(2)
#define G_RM_VPLEX_SCREEN           RM_VPLEX_SCREEN(1)
#define G_RM_VPLEX_SCREEN2          RM_VPLEX_SCREEN(2)
