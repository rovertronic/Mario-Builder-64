...
#define SOUND_GENERAL_LOUD_BUBBLE                /* 0x30100080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x10, 0x00, SOUND_DISCRETE)
...
#define SOUND_GENERAL_COIN_MULTI                 /* 0x38128080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x13, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE) // unverified
...
#define SOUND_MOTOS                              /* 0x30762080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x76, 0x20, SOUND_DISCRETE)
#define SOUND_GENERAL_VANISH_SFX                 /* 0x30762080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x77, 0x20, SOUND_DISCRETE) // unverified
...
#define SOUND_OBJ_BOWSER_WALK                    /* 0x50030080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x03, 0x80, SOUND_DISCRETE)
#define SOUND_OBJ_BOWSER_TAIL_PICKUP             /* 0x50050080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x05, 0x80, SOUND_DISCRETE)
#define SOUND_OBJ_BOWSER_DEFEATED                /* 0x50060080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x06, 0x80, SOUND_DISCRETE)
#define SOUND_OBJ_BOWSER_SPINNING                /* 0x50070080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x07, 0xF0, SOUND_DISCRETE)
#define SOUND_OBJ_BOWSER_INHALING                /* 0x50080080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x08, 0xF0, SOUND_DISCRETE)
...
#define SOUND_OBJ_HEAVEHO_PREVIEW                /* 0x504F0080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x50, 0x40, SOUND_DISCRETE) // unverified
...
#define SOUND_AIR_BOWSER_SPIT_FIRE               /* 0x60000000 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x00, 0x80, 0)
...
#define SOUND_GENERAL2_BOWSER_EXPLODE            /* 0x80600080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL2, 0x60, 0x60, SOUND_DISCRETE)
#define SOUND_GENERAL2_BOWSER_KEY                /* 0x80610080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL2, 0x61, 0x70, SOUND_DISCRETE)
...
#define SOUND_OBJ2_BOWSER_ROAR                   /* 0x90040080 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x04, 0x80, SOUND_DISCRETE)
