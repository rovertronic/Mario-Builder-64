...
#define SOUND_ACTION_QUICKSAND_STEP              /* 0x042E0081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x2E, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_ACTION_SNUFFIT_BULLET_HIT_METAL    /* 0x0458A081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x58, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE) // unverified
...
#define SOUND_GENERAL_LOUD_BUBBLE                /* 0x30100081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x10, 0x00, SOUND_DISCRETE)
...
#define SOUND_GENERAL_COIN_MULTI                 /* 0x38128081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x13, 0x80, SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE) // unverified
...
#define SOUND_GENERAL_BOWSER_BOMB_EXPLOSION      /* 0x312F0081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x2F, 0xFF, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
...
#define SOUND_GENERAL_BOX_PREVIEW                /*            */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x31, 0x80, SOUND_DISCRETE) // unverified
...
#define SOUND_GENERAL_DOOR_TURN_KEY              /* 0x303B0081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x3B, 0x80, SOUND_DISCRETE)
...
#define SOUND_GENERAL_RACE_GUN_SHOT              /* 0x314D4081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x4D, 0xFF, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE) // unverified
...
#define SOUND_GENERAL_CRAZY_BOX_BOING_SLOW       /* 0x306C4081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x6C, 0x80, SOUND_DISCRETE) // unverified
...
#define SOUND_MOTOS                              /* 0x30762081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x76, 0x20, SOUND_DISCRETE)
#define SOUND_GENERAL_VANISH_SFX                 /* 0x30762081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x77, 0x20, SOUND_DISCRETE) // unverified
...
#define SOUND_OBJ_BOWSER_WALK                    /* 0x50030081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x03, 0x80, SOUND_DISCRETE)
#define SOUND_OBJ_BOWSER_TAIL_PICKUP             /* 0x50050081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x05, 0x80, SOUND_DISCRETE)
#define SOUND_OBJ_BOWSER_DEFEATED                /* 0x50060081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x06, 0x80, SOUND_DISCRETE)
#define SOUND_OBJ_BOWSER_SPINNING                /* 0x50070081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x07, 0xF0, SOUND_DISCRETE)
#define SOUND_OBJ_BOWSER_INHALING                /* 0x50080081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x08, 0xF0, SOUND_DISCRETE)
...
#define SOUND_OBJ_GOOMBA_PREVIEW                 /*            */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x49, 0x60, SOUND_DISCRETE)
...
#define SOUND_OBJ_HEAVEHO_PREVIEW                /* 0x504F0081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x50, 0x40, SOUND_DISCRETE) // unverified
...
#define SOUND_AIR_BOWSER_SPIT_FIRE               /* 0x60000001 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x00, 0x80, 0)
#define SOUND_AIR_AMP_PREVIEW                    /* 0x60010001 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x01, 0x80, SOUND_DISCRETE)
...
#define SOUND_MENU_STAR_SOUND                    /* 0x701EFF81 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x1E, 0xB0, SOUND_DISCRETE)
...
#define SOUND_GENERAL2_QUIET_EXPLOSION           /*            */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL2, 0x4C, 0x80, SOUND_DISCRETE)
...
#define SOUND_GENERAL2_BOWSER_EXPLODE            /* 0x80600081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL2, 0x60, 0x60, SOUND_DISCRETE)
#define SOUND_GENERAL2_BOWSER_KEY                /* 0x80610081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL2, 0x61, 0x70, SOUND_DISCRETE)
...
#define SOUND_GENERAL2_BUTTON_PRESS               /* 0x305A4081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL2, 0x5A, 0x40, SOUND_DISCRETE) // unverified
...
#define SOUND_OBJ2_BOWSER_ROAR                   /* 0x90040081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x04, 0x80, SOUND_DISCRETE)
