...
typedef	struct	{
  ...
  u64  *imagePtr;	/* DRAM ��Υƥ������㥽�������ɥ쥹          */
  u16	imageLoad;	/* LoadBlock, LoadTile �Τɤ������Ѥ��뤫   */
  u8	imageFmt;	/* �ƥ�����Υե����ޥå� G_IM_FMT_*          */
  u8	imageSiz;	/* �ƥ�����Υ�����       G_IM_SIZ_*          */
  u16   imagePal; 	/* �ѥ�å��ֹ�                               */
  u16	imageFlip;	/* ���᡼���κ���ȿž  G_BG_FLAG_FLIPS ��ȿž */

  /* �ʲ��Ͻ�����롼���� guS2DInitBg() ������ꤵ���Τǥ桼������
     �ꤹ��ɬ�פϤʤ� */
  u16	tmemW;		/* frame 1 �饤��� TMEM �� Word ������
                           LoadBlock �λ� GS_PIX2TMEM(imageW/4,imageSiz)
                           LoadTile  �λ� GS_PIX2TMEM(frameW/4,imageSiz)+1 */
  u16	tmemH;		/* ���٤˥����ɤǤ��� TMEM �⤵ (s13.2) 4����
			   �̾�ƥ�������λ�   512/tmemW*4
			   CI  �ƥ�������λ�   256/tmemW*4           */
  u16	tmemLoadSH;	/* SH ��
			   LoadBlock �λ� tmemSize/2-1
			   LoadTile  �λ� tmemW*16-1                  */
 ...
 *	2D Objects
 *---------------------------------------------------------------------------*/
#define	G_OBJ_FLAG_FLIPS	1<<0		/* S ����ȿž */
#define	G_OBJ_FLAG_FLIPT	1<<4		/* T ����ȿž */

typedef struct {
  s16  objX;		/* s10.2 OBJ ����ü X ��ɸ                 */
  u16  scaleW;		/* u5.10 ���������������                */
  u16  imageW;		/* u10.5 �ƥ����������   (S ������Ĺ��)   */
  u16  paddingX;	/* ̤���� ��� 0                           */
  s16  objY;		/* s10.2 OBJ ����ü Y ��ɸ                 */
  u16  scaleH;		/* u5.10 �⤵�������������              */
...
typedef	struct	{
  ...
  u64	*image;		/* DRAM ��Υƥ������㥽�������ɥ쥹              */
  u16	tmem;		/* ��������� TMEM ��ɥ��ɥ쥹 (8byteWORD)     */
  u16	tsize;		/* Texture ������     �ޥ��� GS_TB_TSIZE() �ǻ��� */
  u16	tline;		/* Texture 1 �饤���� �ޥ��� GS_TB_TLINE() �ǻ��� */
  u16	sid;		/* STATE ID  4 ���ܿ��� 0,4,8,12 �Τɤ줫         */
  u32	flag;		/* STATE flag  */
  u32	mask;		/* STATE mask  */
...
typedef	struct	{
  ...
  u64	*image;		/* DRAM ��Υƥ������㥽�������ɥ쥹              */
  u16	tmem;		/* ��������� TMEM ��ɥ��ɥ쥹 (8byteWORD)     */
  u16	twidth;		/* Texture ��      �ޥ��� GS_TT_TWIDTH()  �ǻ���  */
  u16	theight;	/* Texture �⤵    �ޥ��� GS_TT_THEIGHT() �ǻ���  */
  u16	sid;		/* STATE ID  4 ���ܿ��� 0,4,8,12 �Τɤ줫         */
  u32	flag;		/* STATE flag  */
  u32	mask;		/* STATE mask  */
...
typedef	struct	{
  ...
  u64	*image;		/* DRAM ��Υƥ������㥽�������ɥ쥹              */
  u16	phead;		/* ��������Ƭ�Υѥ�å��ֹ� 256 �ʾ� 511 �ʲ�     */
  u16	pnum;		/* �����ɤ���ѥ�åȿ� - 1                       */
  u16   zero;		/* ��� 0 ����������                              */
  u16	sid;		/* STATE ID  4 ���ܿ��� 0,4,8,12 �Τɤ줫         */
  u32	flag;		/* STATE flag  */
