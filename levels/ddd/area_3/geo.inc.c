...
const GeoLayout ddd_area_3_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, ddd_dl_Cylinder_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_FORCE, ddd_dl_Cylinder_mesh_layer_0),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout ddd_area_3[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, 0, 0, -67230, 0, -100, -67230, geo_camera_main),
				GEO_OPEN_NODE(),
