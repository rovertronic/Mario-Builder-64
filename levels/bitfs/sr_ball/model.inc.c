Gfx sr_ball_metal_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 sr_ball_metal_rgba16[] = {
...
Vtx sr_ball_Plane_008_mesh_layer_5_vtx_0[4] = {
...
Gfx sr_ball_Plane_008_mesh_layer_5_tri_0[] = {
	gsSPVertex(sr_ball_Plane_008_mesh_layer_5_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPEndDisplayList(),
};


Gfx mat_sr_ball_metal_ball[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, ENVIRONMENT, 0, TEXEL0, 0, 0, 0, 0, TEXEL0, ENVIRONMENT, 0, TEXEL0, 0),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, sr_ball_metal_rgba16),
...
Gfx sr_ball_Plane_008_mesh_layer_5[] = {
	gsSPDisplayList(mat_sr_ball_metal_ball),
	gsSPDisplayList(sr_ball_Plane_008_mesh_layer_5_tri_0),
	gsSPEndDisplayList(),
};

Gfx sr_ball_material_revert_render_settings[] = {
	gsDPPipeSync(),
