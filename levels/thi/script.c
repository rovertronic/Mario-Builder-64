...
const LevelScript level_thi_entry[] = {
	...
	AREA(1, thi_area_1),
		...
		WARP_NODE(0x09/*exit*/, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 2942, 6051, -4288, 0, -90, 0, (0x09 << 16), bhvInstantActiveWarp),
	...
	AREA(2, thi_area_2),
		...
		WARP_NODE(0x05, LEVEL_THI, 0x01, 0x02, WARP_NO_CHECKPOINT),
		WARP_NODE(0x02/*rec*/, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(240, LEVEL_BITS, 0x01, 0x08, WARP_NO_CHECKPOINT),
		WARP_NODE(241, LEVEL_BITS, 0x01, 0x07, WARP_NO_CHECKPOINT),
		WARP_NODE(0x01/*exit*/, LEVEL_THI, 0x01, 0x09, WARP_NO_CHECKPOINT),
